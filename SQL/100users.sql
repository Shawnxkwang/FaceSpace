...
insert into UserTable (email, firstName, lastName, birthday) values ('tfranklin23@networkadvertising.org', 'Tammy', 'Franklin', TO_DATE('1993-01-01', 'YYYY-mm-dd'));
...
insert into UserTable (email, firstName, lastName, birthday) values ('bwashington2q@ezinearticles.com', 'Bruce', 'Washington', TO_DATE('1993-01-01', 'YYYY-mm-dd'));
